...
const genSubject = ({ username, viewCount }) => {
  return `哈囉 ${username}，你的薪資工時資料已經幫助了 ${viewCount} 位求職者`;
}

/**
 * @param {string} params.username 使用者名稱
 * @param {number} params.salaryWorkTime.viewCount 瀏覽次數
 * @param {string} params.salaryWorkTime.companyName 公司名稱
 * @param {string} params.salaryWorkTime.jobTitle 職稱
 * @param {number} params.salaryWorkTime.weekWorkHour 一週總工時
 * @param {string} params.salaryWorkTime.overtimeFrequency 加班頻率
 * @param {number} params.salaryWorkTime.salary.amount 薪資
 * @param {string} params.salaryWorkTime.salary.type 薪資種類
 * @param {string} params.relatedContent 相關領域的內容
                              ...
                              <tr class="container__row">
                                <td class="container__cell" width="100%" align="left" valign="top" style="padding-left: 16px; padding-right: 16px; padding-bottom: 16px;">
                                  <p class="center text p" style="margin: 0; color: #333333; font-family: 'PingFang TC','微軟正黑體','Microsoft JhengHei','Helvetica Neue',Helvetica,Arial,sans-serif; font-size: 16px; line-height: 1.5; width: 100%; display: block; text-align: center; margin-left: auto; margin-right: auto;">
                                    <a href="https://www.goodjob.life" class="a" style="color: inherit; font-family: 'PingFang TC','微軟正黑體','Microsoft JhengHei','Helvetica Neue',Helvetica,Arial,sans-serif; text-decoration: none;"><span class="a__text" style="color: inherit; text-decoration: none;"><img src="https://image.goodjob.life/logo_570x70.png" width="285" height="35" alt="goodjob 職場透明化運動" border="0" class="img__block" style="display: block; max-width: 100%; margin-right: auto; margin-left: auto;" /></span></a>
                                  </p>
                                </td>
                              </tr>
                            </table> <!--[if mso | IE]> </td>
                                        ...
                                        <td> <![endif]--> <table class="block__table" role="presentation" border="0" align="center" cellpadding="0" cellspacing="0" width="100%">
                                            <tr class="block__row">
                                              <td class="block__cell" width="100%" align="left" valign="top" style="background-color: #FFFFFF; border-radius: 4px; padding: 32px 40px;" bgcolor="#FFFFFF">
                                                ...
                                                <!-- start h1 -->
                                                <h1 class="heading-m header h1" style="margin: 0; color: #333333; font-family: 'PingFang TC','微軟正黑體','Microsoft JhengHei','Helvetica Neue',Helvetica,Arial,sans-serif; line-height: 1.4; font-size: 28px; font-weight: 700;">哈囉 wutingy，你的薪資工時資料已經幫助了 35 位求職者</h1>
                                                <!-- end h1 -->
                                                <!-- start content -->
                                                <div class="row">
                                                  <table class="row__table" width="100%" align="center" role="presentation" border="0" cellpadding="0" cellspacing="0" style="table-layout: fixed;">
                                                    <tr class="row__row">
                                                      <td class="pt-xs pb-xs column col-sm-12" width="700" style="padding-bottom: 16px; padding-top: 16px;width: 100%" align="left" valign="top">
                                                              ...
                                                              <td> <![endif]--> <table class="block__table" role="presentation" border="0" align="center" cellpadding="0" cellspacing="0" width="100%">
                                                                  <tr class="block__row">
                                                                    <td class="block__cell" width="100%" align="left" valign="top" style="background-color: #FFFFFF; border-radius: 4px; border: 1px solid #EEEEEE; box-shadow: 0 0 5px #DDDDDD; padding: 24px;" bgcolor="#FFFFFF">
                                                                      <a href="https://google.com" class="a" style="color: inherit; font-family: 'PingFang TC','微軟正黑體','Microsoft JhengHei','Helvetica Neue',Helvetica,Arial,sans-serif; text-decoration: none;"><span class="a__text" style="color: inherit; text-decoration: none;">
                                                                          <table class="time-and-salary-article table" width="100%" border="0" cellspacing="0" cellpadding="0" style="border-collapse: collapse;">
                                                                            <tr class="tr">
                                                                              <th align="left" width="20%" style="font-size: 15px; font-weight: 400; line-height: 1.4; padding: 4px; color: #969696;">公司名稱</th>
                                                                              <td align="left" class="td" style="border-collapse: collapse; font-size: 15px; font-weight: 400; line-height: 1.4; padding: 4px; color: #333333;">貝殼放大股份有限公司</td>
                                                                            </tr>
                                                                            <tr class="tr">
                                                                              <th align="left" width="20%" style="font-size: 15px; font-weight: 400; line-height: 1.4; padding: 4px; color: #969696;">職稱</th>
                                                                              <td align="left" class="td" style="border-collapse: collapse; font-size: 15px; font-weight: 400; line-height: 1.4; padding: 4px; color: #333333;">專案經理</td>
                                                                            </tr>
                                                                            <tr class="tr">
                                                                              <th align="left" width="20%" style="font-size: 15px; font-weight: 400; line-height: 1.4; padding: 4px; color: #969696;">一週總工時</th>
                                                                              <td align="left" class="td" style="border-collapse: collapse; font-size: 15px; font-weight: 400; line-height: 1.4; padding: 4px; color: #333333;">55</td>
                                                                            </tr>
                                                                            <tr class="tr">
                                                                              <th align="left" width="20%" style="font-size: 15px; font-weight: 400; line-height: 1.4; padding: 4px; color: #969696;">加班頻率</th>
                                                                              <td align="left" class="td" style="border-collapse: collapse; font-size: 15px; font-weight: 400; line-height: 1.4; padding: 4px; color: #333333;">經常</td>
                                                                            </tr>
                                                                            <tr class="tr">
                                                                              <th align="left" width="20%" style="font-size: 15px; font-weight: 400; line-height: 1.4; padding: 4px; color: #969696;">薪資</th>
                                                                              <td align="left" class="td" style="border-collapse: collapse; font-size: 15px; font-weight: 400; line-height: 1.4; padding: 4px; color: #333333;">50,000 / 月</td>
                                                                            </tr>
                                                                          </table>
                                                                        </span></a>
                                                                    </td>
                                                              ...
                                                              <table border="0" cellspacing="0" cellpadding="0" class="table" style="border-collapse: collapse;">
                                                                <tr class="tr">
                                                                  <td align="center" bgcolor="#fcd406;" class="td" style="border-collapse: collapse;">
                                                                    <a href="https://google.com" class="button-m a" style="font-family: 'PingFang TC','微軟正黑體','Microsoft JhengHei','Helvetica Neue',Helvetica,Arial,sans-serif; text-decoration: none; padding: 10px 24px; font-weight: 700; background-color: #FCD406; color: #000000; display: inline-block;"><span class="a__text" style="text-decoration: none; color: #000000;">留下你的工作心得</span></a>
                                                                  </td>
                                                                </tr>
                                                              </table>
                                                            </td>
                                                        ...
                                                        <!-- end button -->
                                                        <p class="p mt-s text p" style="display: block; margin: 0; color: #333333; font-family: 'PingFang TC','微軟正黑體','Microsoft JhengHei','Helvetica Neue',Helvetica,Arial,sans-serif; font-size: 16px; line-height: 1.5; margin-top: 32px;"> 或是查看<span class="bold" style="font-weight: 700;">軟體工程師</span>領域的精選文章：<br />
                                                          <a class="border-blue-link a" href="https://google.com" style="font-size: 16px; font-family: 'PingFang TC','微軟正黑體','Microsoft JhengHei','Helvetica Neue',Helvetica,Arial,sans-serif; text-decoration: underline; color: #325BBD;"><span class="a__text" style="text-decoration: underline; color: #325BBD;">達佛羅 工作經驗分享 1</span></a><br />
                                                          <a class="border-blue-link a" href="https://google.com" style="font-size: 16px; font-family: 'PingFang TC','微軟正黑體','Microsoft JhengHei','Helvetica Neue',Helvetica,Arial,sans-serif; text-decoration: underline; color: #325BBD;"><span class="a__text" style="text-decoration: underline; color: #325BBD;">達佛羅 工作經驗分享 2</span></a><br />
                                                          <a class="border-blue-link a" href="https://google.com" style="font-size: 16px; font-family: 'PingFang TC','微軟正黑體','Microsoft JhengHei','Helvetica Neue',Helvetica,Arial,sans-serif; text-decoration: underline; color: #325BBD;"><span class="a__text" style="text-decoration: underline; color: #325BBD;">達佛羅 工作經驗分享 3</span></a>
                                                        </p>
                                                      </td>
                                                    </tr>
                                                  </table>
